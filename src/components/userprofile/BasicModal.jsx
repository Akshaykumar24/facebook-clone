    ...
    <div>
      ...
      >
        <Box sx={style}>
          ...
          <UploadProfPicStyled>
            {(!imageLoading && imageUrl.length > 1) ||
            (!imageLoading && coverImageUrl.length > 1) ? (
              <div>
                {" "}
                <img
                  className="previewImage"
                  src={title === "Edit Cover Photo" ? coverImageUrl : imageUrl}
                  alt=""
                />{" "}
                <span className="imageCloseIcon" onClick={handleImageClose}>
                  <CloseIcon />
                </span>
              </div>
            ) : !imageLoading ? (
